...
export const getTableChips = (data) => {
  return api.post("/data_query/get_table_chips", data);
};

export const getBetArea =(data) =>{
  return api.post("/data_query/get_bet_area",data);
}
